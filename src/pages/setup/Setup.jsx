        ...
        <div className={styles.setupContainer}>
            ...
            <div className={styles.setup} style={{ animation }}>
                <form>
                    ...
                    <TextInput placeholder="Name" width="200px" label="Name" backgroundColor='rgba(0, 0, 0, 0.4)' borderColor='transparent' input={name} setInput={setName}
                    ...
                    <TextInput placeholder="Email" label="Email" width="200px" backgroundColor='rgba(0, 0, 0, 0.4)' borderColor='transparent' input={email} setInput={setEmail}
                        leftIcon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
